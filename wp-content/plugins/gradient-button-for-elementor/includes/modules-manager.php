...
final class Manager {
	...
	private function is_module_active( $module_id ) {
		...
		$options = get_option( 'gradient_button_elementor_active_modules', [] );
	...
	public function __construct() {
		$modules = [
			'button', // This should match the name of the folder located inside the Modules folder - Your widget/element name!
		];

		// Fetch all modules data
		foreach ( $modules as $module ) {
			$this->_modules[ $module ] = require GRADIENT_BUTTON_ELEMENTOR_MODULES_PATH . $module . '/module.info.php';
		}
